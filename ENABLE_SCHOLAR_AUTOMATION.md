...
1. (Optional) Add repository secret SCHOLAR_URL with your Google Scholar profile URL:
   - Go to Settings → Secrets and variables → Actions → New repository secret
   - Name: SCHOLAR_URL
   - Value: https://scholar.google.com/citations?hl=en&user=Yda5OkEAAAAJ

   If this secret is not set, the workflow uses this repository's default profile URL:
   https://scholar.google.com/citations?hl=en&user=Yda5OkEAAAAJ
